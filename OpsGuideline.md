...
## 3. 脆弱性への対応
### 3.1. 脆弱性管理
システムを構成するOS及びソフトウェアの脆弱性情報(セキュリティインシデント)について
運用・保守部署にて以下の方針に沿って管理・対応する。
...
* 各インシデント及びその対応内容について記録を残すこと
	...
	- 判断責任者
	- 対処完了日
* 管理体制、インシデント発生時の対応体制及び連絡体制を明確にしておくこと
* 新たな脆弱性情報について速やかに内容を確認し、各部門へ脆弱性対象の使用有無、パッチの適用状況を確認すること
* システムに脆弱性攻撃の疑いがある場合、対応体制及び連絡体制に沿って速やかに対処すること
