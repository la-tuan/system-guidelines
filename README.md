...
- 必ず一通り読み、何が書かれていて、どのようなことにケアすべきかを把握しておく
   - medibaでは本ガイドラインに沿った開発を前提とする
   - KDDIから求められていること、過去のナレッジが反映された内容になっている
- 新規開発、大規模改修など開発方針としてチーム内で確認する
   - 個人情報の扱い、セキュリティ関連は原則ガイドラインに従う
   - 設計前やリリース前に考慮漏れがないかチェック項目として活用する
- 本ガイドラインは適宜内容を更新していきますので、更新内容は必ず確認する
