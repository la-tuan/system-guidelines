...
- 新しいCookieを発行する場合は、CTOの許可を取る。特にCookie名は同じものを流用すると思わぬ弊害がでるため、かならず事前に確認すること
- ユーザ側にHTMLの編集を可能とさせるような機能、信頼できない他者の記述したJavascriptを実行できるようなサイトを構築する場合は、かならずドメインを別のものにすること
